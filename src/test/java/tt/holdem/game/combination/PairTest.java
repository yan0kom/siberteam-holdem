...
class PairTest {
    ...
    void compareToSameTypeCombination() {
        ...
        assertTrue(_KdJs7h5c5h.compareToSameTypeCombination(_KdJs7c7h5s) < 0); // pair of 5 < pair of 7
        assertTrue(_KdJs7d7s5s.compareToSameTypeCombination(_KdJs7h5c5h) > 0); // pair of 7 > pair of 5
        assertTrue(_KdJs7c7h5s.compareToSameTypeCombination(_KdJs7d7s5s) == 0); // all cards have same rank
        assertTrue(_QdJsJh7c5s.compareToSameTypeCombination(_KdJsJh7c5s) < 0); // both pair of J but first kicker different
        assertTrue(_KdJsJhTc5s.compareToSameTypeCombination(_KdJsJh7c5s) > 0); // both pair of J but second kicker different
        assertTrue(_KdJsJhTc5s.compareToSameTypeCombination(_KdJsJhTc4s) > 0); // both pair of J but third kicker different
    }
