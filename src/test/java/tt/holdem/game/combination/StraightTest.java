...
class StraightTest {
    ...
    void compareToSameTypeCombination() {
        ...
        assertTrue(_Td9s8h7c6h.compareTo(_Tc9c8h7c6h) == 0); // all cards have same rank
        assertTrue(_QcJcTh9c8s.compareTo(_Tc9c8h7c6h) > 0); // straight rank different
        assertTrue(_6c5c4h3c2s.compareTo(_QcJcTh9c8s) < 0); // straight rank different
    }
